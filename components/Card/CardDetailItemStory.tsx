            ...
            <div className='flex w-full md:w-3/4 lg:gap-5 gap-2 '>
                ...
                <div className='w-2/3 md:w-2/3 lg:w-3/4 md:mt-2  flex text-sm lg:text-base flex-col gap-2 lg:gap-3'>
                    ...
                    <div className='flex flex-col lg:gap-2 gap-1'>
                        <p className='max-w-full overflow-hidden truncate'>Tác giả: <span className='text-[#00000099] '>Nhĩ Căn abc abc bac bac bac bac acb</span></p>
                        <p className='max-w-full overflow-hidden truncate'>Contributor: <span className='text-[#00000099]'>Đình Phong</span></p>
                        <p>Tình trạng: <span className='text-[#098409]'>Hoàn thành</span></p>
                    </div>
                    <ul className='flex gap-1 md:gap-2 lg:gap-3 lg:text-xs text-[10px] flex-wrap'>
                        <li className='w-max cursor-pointer lg:py-1  px-4 border border-[#4598f8] hover:text-[#098409] rounded-full'>Tiên Hiệp</li>
                        <li className='w-max cursor-pointer lg:py-1  px-4 border border-[#4598f8] hover:text-[#098409] rounded-full'>Trinh Thám </li>
                        <li className='w-max cursor-pointer lg:py-1  px-4 border border-[#4598f8] hover:text-[#098409] rounded-full'>Xuyên không</li>
                        <li className='w-max cursor-pointer lg:py-1  px-4 border border-[#4598f8] hover:text-[#098409] rounded-full'> Hậu Cung - Harem</li>
                      
                    </ul>
                    <ul className='flex gap-1 md:gap-2 lg:gap-3 text-[10px] lg:text-xs flex-wrap'>
                        <li className='w-max cursor-pointer lg:py-1  px-4 border border-[#098409] hover:text-[#098409] rounded-full'>Truyện Hay</li>
                        <li className='w-max cursor-pointer lg:py-1  px-4 border border-[#098409] hover:text-[#098409] rounded-full'>Đại Thần Dịch</li>
                        <li className='w-max cursor-pointer lg:py-1  px-4 border border-[#098409] hover:text-[#098409] rounded-full'>Độc quyền BNS</li>
                        <li className='w-max cursor-pointer lg:py-1  px-4 border border-[#098409] hover:text-[#098409] rounded-full'>Tác Đại Thần</li>
                    </ul>
            ...
            <div className='flex md:w-1/4  flex-col bg-transparent gap-2'>
                ...
                <div className='flex items-center group border h-[60px] relative md:text-  rounded-lg overflow-hidden'>
                    <p className='text-[#12a62f] relative p-4 flex justify-center w-1/2 text-2xl font-sans font-bold'>
                        5.0 <span className='text-xs absolute top-2 right-2  text-gray-400 font-normal'>/5</span>
                    </p>
                    <span className='w-1/2 bg-[#f4f4f4] p-4 h-ful flex flex-col justify-center items-center'>Đánh giá:<span>66 lượt</span></span>
                    <div className='w-full h-full  opacity-0 group-hover:opacity-100 bg-[#4c4c4c27] text-[#128c7e] flex justify-center items-center absolute top-0'><FaRegPlusSquare size={18} /></div>
                </div>
                <ListNominationStory />
            </div>
        </div>
