    ...
    <div className="flex gap-3 text-sm hover:bg-gray-200 px-3 py-2">
      ...
      <div className="flex flex-col w-full overflow-hidden  gap-1">
        <span className="flex cursor-pointer items-center w-full  gap-1">
          ...
          <p className="hover:text-[#128c7e] w-full truncate">Quỷ Đạo Chi Chủ Thiên Địa Chí Tôn Thiên Thòi </p>
        </span>
        <p className="font-semibold text-[#999999] w-full truncate">Bất Phong Tâm Du Điều</p>
      </div>
    </div>
  );
}
