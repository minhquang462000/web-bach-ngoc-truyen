...
import CardAuthorStory from "../Card/CartAuthorStory";

export interface IListAuthorStoryProps {}

export default function ListAuthorStory(props: IListAuthorStoryProps) {
  return (
    <div className=" w-full   grid lg:grid-cols-3 gap-3 bg-transparent">
      <nav className="flex shadow p-2  items-center bg-white rounded-md justify-between lg:col-span-3">
        {" "}
